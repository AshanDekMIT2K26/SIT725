...
// MongoDB Connection String - Must match the one in index.js
const dbURI = 'mongodb://localhost:27017/locateasocketDB';

// Define the schema and model (must be the same as in index.js)
...
// Data to be inserted (data from scripts.js)
